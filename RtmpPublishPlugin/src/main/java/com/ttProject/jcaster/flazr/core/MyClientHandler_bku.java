...
import com.ttProject.jcaster.flazr.core.RtmpSender_bku.Event;

/**
 * クライアントハンドラー動作
 * @author taktod
 */
public class MyClientHandler_bku extends ClientHandler {
	/** 動作ロガー */
	private static final Logger logger = Logger.getLogger(MyClientHandler_bku.class);
	...
	private RtmpSender_bku sender; // publisherのかわり。
	/**
	 * コンストラクタ
	 * @param options
	 */
	public MyClientHandler_bku(ClientOptions options, RtmpSender_bku sender) {
		super(options);
