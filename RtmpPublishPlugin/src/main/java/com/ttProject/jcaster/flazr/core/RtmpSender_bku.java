 ...
 */
public class RtmpSender_bku implements RtmpReader {
	/** ロガー */
	private static final Logger logger = Logger.getLogger(RtmpSender_bku.class);
	...
	private MyClientHandler_bku clientHandler = null;
	 ...
	 * @param streamName
	 */
	public RtmpSender_bku(String rtmpAddress, String streamName) {
	...
	private ClientBootstrap getBootstrap(final Executor executor, final ClientOptions options) {
		...
		clientHandler = new MyClientHandler_bku(options, this);
...
//				channel.write(videoMshTag.getBuffer());
	...
	@Override
	public void setAggregateDuration(int arg0) {
		// TODO Auto-generated method stub
