 ...
 * もしかしてこの処理ってthread2ついるの？
 */
public class FlvDecoder_bku2 implements Runnable {
	/** ロガー */
	private final Logger logger = Logger.getLogger(FlvDecoder_bku2.class);
	/** ボリューム 0 - 100 */
